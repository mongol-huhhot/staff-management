...
import { showSnackbar } from "@/components/Snackbar.vue"; // Abstracted notification utility
...
export const useBaseStore = defineStore("baseStore", () => {
  ...
  dbStore.commonParams.tid = tid;

  dbStore.commonParams.SQL_PATH = `${dbStore.commonParams.tid}/generic-folder/menuSqlTemplate.sql`;

  console.log("tid=", dbStore.commonParams.tid)
  ...
  const clearAuth = () => dbStore.clearAuth();
