<!-- 
  AppWrapper.vue
  This component serves as the main wrapper for the staff management application, integrating various components and managing state.
  It includes a responsive split frame layout with a data browser on the left and a staff detail template on the right.
  The header contains buttons for toggling between different data states (draft, pending, approved) and for adding new staff.
  The component uses Vue's Composition API to manage state and handle events.
  -->
<script setup>
