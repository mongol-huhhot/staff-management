...
<template>
  <v-form>
    ...
    <v-row>
      ...
      <!-- <v-col cols="6" md="3">
        <LookupTable
          identify_code="countries"
          :params="{}"
          v-model="localStaffData.country"
          label="国家"
          :density="dentisyDef"
          :creatable="true"
          :returnObject="false"
      ...
      <v-col cols="6" md="3">
        <LookupTable
          identify_code="job_classifications"
          :params="{}"
          v-model="localStaffData.job_classification"
          label="職種"
          :density="dentisyDef"
          :creatable="true"
          :returnObject="false"
      ...
      <v-col cols="6" md="3">
        <LookupTable
          identify_code="job_grades"
          :params="{}"
          v-model="localStaffData.job_grade"
          label="職格"
          :density="dentisyDef"
          :creatable="true"
          :returnObject="false"
