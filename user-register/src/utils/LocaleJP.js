export const localeJP = {
    ...
    advancedFilterTextNotEqual: '等しいではない',
    advancedFilterStartsWith: '前方一致',
    advancedFilterEndsWith: '後方一致',
    ...
    ariaPageSizeSelectorLabel: '1ページあたり',
