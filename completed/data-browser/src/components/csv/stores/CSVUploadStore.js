...
import { useDBConnectionStore } from '@/components/csv/stores/DBConnectionStore'
...
export const useCSVUploadStore = defineStore('CSVUploadStore', () => { 
    ...
    const CONST_DEF = {
        sql_path: 'fuji-sangyo/payroll/payroll-csv-Template.sql',
    ...
    const save = async ( csvdata, params={TRANSACTION:1}, doTransaction=false ) => {
        ...
        try {
            ...
            /** CSV UPLOAD データをテーブル tbx_salary_item_values_uploadに入れるかどうか */
            if( doTransaction ) {
            ...
            await loadErrorLog(transaction_id);
