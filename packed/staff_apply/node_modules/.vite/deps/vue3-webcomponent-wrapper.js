...
//#region node_modules/vue3-webcomponent-wrapper/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		return (() => {
			...
			var e = {};
			t.d(e, { default: () => C }), Array.isArray;
			const n = (t) => {
				const e = Object.create(null);
				return (n) => e[n] || (e[n] = t(n));
			}, i = n(((t) => t.charAt(0).toUpperCase() + t.slice(1))), u = n(((t) => t ? `on${i(t)}` : ""));
			var c = /-(\w)/g, a = function(t) {
				return t.replace(c, (function(t, e) {
					return e ? e.toUpperCase() : "";
				}));
			}, s = /\B([A-Z])/g, f = function(t) {
			...
			function _(t, e, n) {
				return _ = O() ? Reflect.construct : function(t, e, n) {
					var r = [null];
					r.push.apply(r, e);
			...
			function C(t, e, n, r) {
				var o, i, c, s = t, b = !1, h = function(t) {
					(function(t, e) {
					...
					var f, h, g, _, C = (f = x, h = O(), function() {
						var t, e = A(f);
						if (h) {
					...
					function x() {
						...
						}(this, x), (t = C.call(this))._wrapper = void 0, t._component = void 0, t._props = void 0, t._slotChildren = void 0, t._mounted = !1, t._props = {}, t._slotChildren = [], new MutationObserver((function(e) {
							for (var n = 0; n < e.length; n++) {
								var r = e[n];
								!b || "attributes" !== r.type || r.target !== w(t) || r.attributeName && t.syncAttribute(r.attributeName);
							}
						})).observe(w(t), {
							childList: !0,
							subtree: !0,
					...
					return g = x, _ = [
						...
						},
						{
							...
							value: function(t) {
								...
								this.hasOwnProperty(t) ? r = this[t] : this.hasAttribute(t) && (r = this.getAttribute(t)), this._props[n] = function(t, e) {
									...
									if (p(n)) return "true" === t || "false" === t ? "true" === t : "" === t || t === e || null != t;
									if (y(n)) {
										var r = parseFloat(t);
										return isNaN(r) ? t : r;
									}
									return t;
								}(r, t, c[n]), null === (e = this._component) || void 0 === e || e.$forceUpdate();
							}
						},
						{
							key: "syncSlots",
							value: function() {
								...
								this._slotChildren = function(t, e) {
									for (var n = [], r = 0, o = t.length; r < o; r++) n.push(d(t[r], e));
									return n;
						...
						},
						{
							...
							value: function() {
								var t, e = this;
								this._props = (t = {}, i.forEach((function(e) {
									t[e] = void 0;
						...
						},
						{
							...
							value: function() {
								b && this.syncInitialAttributes();
								var t = this.createEventProxies(s.emits), o = this;
								this._wrapper = e({
									render: function() {
										var e = Object.assign({}, o._props, t);
										return delete e.dataVApp, n(s, e, (function() {
								...
								}), this.syncSlots(), this._component = this._wrapper.mount(this), null != r && r.connectedCallback && r.connectedCallback.bind(this)();
							}
						},
						{
							...
							value: function() {
								var t;
								null === (t = this._wrapper) || void 0 === t || t.unmount();
							}
						}
					], _ && v(g.prototype, _), x;
				}(g(HTMLElement));
				return function() {
					if (!b) {
						var t = Array.isArray(s.props) ? s.props : Object.keys(s.props || {});
						o = t.map(f), i = t.map(a);
						var e = Array.isArray(s.props) ? {} : s.props || {};
						c = i.reduce((function(n, r, o) {
							return n[r] = e[t[o]], n;
						}), {}), b = !0;
					}
				}(), h;
