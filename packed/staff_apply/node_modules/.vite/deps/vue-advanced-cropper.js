import { C as vShow, Cn as withDirectives, Dt as mergeProps, G as createBlock, Jt as renderSlot, K as createCommentVNode, M as Fragment, T as withModifiers, Vt as openBlock, Yt as resolveComponent, Zt as resolveDynamicComponent, et as createVNode, qt as renderList, xn as withCtx } from "./vue.runtime.esm-bundler-DJa8Dn_V.js";
		...
		function i() {
			for (var t = [], n = 0; n < arguments.length; n++) {
				...
				if (s) {
					...
					} else if ("object" === o) if (s.toString === Object.prototype.toString) for (var a in s) e.call(s, a) && s[a] && t.push(a);
...
function j(t, e, i) {
	...
	return H(t) ? (Object.keys(e).forEach((function(s) {
		D(t[s]) ? n[s] = e[s] : H(e[s]) ? H(t[s]) ? n[s] = j(t[s], e[s], i[s]) : n[s] = t[s] ? e[s] : i[s] : !0 === e[s] || !1 === e[s] ? n[s] = Boolean(t[s]) : n[s] = t[s];
	})), n) : t ? e : i;
}
function L(t) {
	var e = Number(t);
...
var k = function() {
	...
	return t.prototype.shift = function() {
		var t = this, e = t.element, i = t.anchor, n = t.position;
		if (e) {
...
var F = {
	...
	methods: {
		...
		onTouchStart: function(t) {
			t.cancelable && !this.disabled && 1 === t.touches.length && (this.touches = b(t.touches), this.hovered || (this.$emit("enter"), this.hovered = !0), t.touches.length && this.initAnchor(this.touches.reduce((function(e, i) {
				return {
...
var N = {
	...
	computed: { classes: function() {
		...
		if (this.horizontalPosition || this.verticalPosition) {
			...
			t = U((f(e = {}, i.classname, !0), f(e, "disabled", this.disabled), e));
...
N.render = function(r, a, h, c, l, u) {
	...
	return openBlock(), createBlock("div", { class: u.classes.root }, [createVNode(d, {
		class: u.classes.draggable,
		onDrag: a[1] || (a[1] = function(t) {
...
var q = {
	...
	computed: { classname: function() {
		var t;
		return Z((f(t = {}, this.position, !0), f(t, "disabled", this.disabled), t));
	} },
	emits: [
		"leave",
		"enter",
...
function lt(t, e) {
	return Math.min(void 0 !== e.right && void 0 !== e.left ? (e.right - e.left) / t.width : Infinity, void 0 !== e.bottom && void 0 !== e.top ? (e.bottom - e.top) / t.height : Infinity);
}
function ut(t, e) {
	var i = {
		left: 0,
...
function mt(t, e) {
	var i = ct(t), n = ct(e);
	return e.width < Infinity && e.height < Infinity ? i > n ? {
		width: e.width,
		height: e.width / i
	} : {
		width: e.height * i,
...
function bt(t) {
	return {
		width: void 0 !== t.right && void 0 !== t.left ? t.right - t.left : Infinity,
		height: void 0 !== t.bottom && void 0 !== t.top ? t.bottom - t.top : Infinity
	};
}
function wt(t, e) {
	return C(C({}, t), {
...
function Mt(t) {
	var e = t.width, i = t.height, n = t.sizeRestrictions, s = {
		minimum: t.aspectRatio && t.aspectRatio.minimum || 0,
		maximum: t.aspectRatio && t.aspectRatio.maximum || Infinity
	}, o = {
...
function xt(t) {
	var e = t.coordinates, i = t.transform, n = t.imageSize, s = t.sizeRestrictions, o = t.positionRestrictions, r = t.aspectRatio, a = t.visibleArea, h = function(t, e) {
		return St({
			coordinates: t,
	...
	return (Array.isArray(i) ? i : [i]).forEach((function(t) {
		var e = {};
		D((e = "function" == typeof t ? t({
			coordinates: c,
			imageSize: n,
			visibleArea: a
		}) : t).width) && D(e.height) || (c = function(t, e) {
			return h(C(C(C({}, t), Mt({
				width: e.width,
				height: e.height,
				sizeRestrictions: s,
		...
		}(c, C(C({}, c), e))), D(e.left) && D(e.top) || (c = h(c, C(C({}, c), e)));
	})), c;
}
function Ct(t) {
	t.event;
	...
	h = ct(m), c = ct(u), void 0 === l && (l = .001), (0 === h || 0 === c ? Math.abs(c - h) < l : Math.abs(c / h) < 1 + l && Math.abs(c / h) > 1 - l) || (u = C(C({}, u), Mt({
		sizeRestrictions: r,
		width: u.width,
		height: u.height,
		aspectRatio: {
	...
	var p = ft(d = ht(d, u.width * i.width / (d.width * m.width)), e({
		visibleArea: d,
		type: "resize"
	}));
	return 1 !== p && (d = ht(d, p), u = ht(u, p)), d = vt(d = at(d, it(nt(u), nt(d))), e({
		visibleArea: d,
		type: "move"
	})), {
		coordinates: u = vt(u, zt(et(d), a)),
		visibleArea: d
	};
}
function Et(t) {
	...
	if (s && o && "manipulateImage" !== e.type) {
		...
		h.width, n.width, ct(n) > ct(a) ? (c.height = .8 * n.height, c.width = c.height * ct(a)) : (c.width = .8 * n.width, c.height = c.width * ct(a));
		var l = ft(h = ht(h, a.width * n.width / (h.width * c.width)), i({
			visibleArea: h,
			type: "resize"
		}));
		h = ht(h, l), 1 !== l && (c.height /= l, c.width /= l), h = vt(h = at(h, it(nt(a), nt(h))), i({
			visibleArea: h,
			type: "move"
		})), a = vt(a, zt(et(h), r));
	}
...
function Wt(t) {
	...
	if ("setCoordinates" === e.type) {
		...
		a > h ? o = ht(o, Math.min(r.width / o.width, lt(o, s({
			visibleArea: o,
			type: "resize"
		})))) : h > a && (o = ht(o, Math.min(r.height / o.height, lt(o, s({
			visibleArea: o,
			type: "resize"
		}))))), o = vt(o = at(o, rt(ut(r, et(o)))), s({
			visibleArea: o,
			type: "move"
		}));
	}
...
function Ot(t) {
	var e = t.imageSize, i = t.visibleArea, n = t.aspectRatio, s = t.sizeRestrictions, o = i || e, r = Math.min(n.maximum || Infinity, Math.max(n.minimum || 0, ct(o))), a = o.width < o.height ? {
		width: .8 * o.width,
		height: .8 * o.width / r
	} : {
		height: .8 * o.height,
...
function Dt(t) {
	...
	return ct(c) > ct(o) ? i = (e = h.height * c.height / o.height) * ct(h) : e = (i = h.width * c.width / o.width) / ct(h), Mt({
		width: i,
		height: e,
		aspectRatio: r,
		sizeRestrictions: a
...
function Ht(t) {
	...
	if (i) {
		var o = {
			...
			width: ct(o) > s ? o.width : o.height * s,
			height: ct(o) > s ? o.width / s : o.height
		}, bt(e())), a = {
...
function Lt(t) {
	var e = t.event, i = t.coordinates, n = t.visibleArea, s = t.sizeRestrictions, o = t.getAreaRestrictions, r = t.positionRestrictions, a = t.adjustStencil, h = e.scale, c = e.move, l = C({}, n), u = C({}, i), d = 1, m = 1, p = h.factor && Math.abs(h.factor - 1) > .001;
	l = at(l, {
		left: c.left || 0,
		top: c.top || 0
	});
	var g = {
		stencil: {
			...
			maximum: Math.min(s.maxWidth ? s.maxWidth / u.width : Infinity, s.maxHeight ? s.maxHeight / u.height : Infinity, lt(u, r))
		},
		area: { maximum: lt(l, o({
			visibleArea: l,
			type: "resize"
	...
	h.factor && p && (h.factor < 1 ? (m = Math.max(h.factor, g.stencil.minimum)) > 1 && (m = 1) : h.factor > 1 && (m = Math.min(h.factor, Math.min(g.area.maximum, g.stencil.maximum))) < 1 && (m = 1)), m && (l = ht(l, m, h.center));
	var f = i.left - n.left, v = n.width + n.left - (i.width + i.left), b = i.top - n.top, w = n.height + n.top - (i.height + i.top);
	return l = vt(l = at(l, ut(l, {
		...
		visibleArea: l,
		type: "move"
	})), u.width = u.width * m, u.height = u.height * m, u.left = l.left + f * m, u.top = l.top + b * m, u = vt(u, zt(et(l), r)), h.factor && p && a && (h.factor > 1 ? d = Math.min(g.area.maximum, h.factor) / m : h.factor < 1 && (d = Math.max(u.height / l.height, u.width / l.width, h.factor / m)), 1 !== d && (l = at(l = vt(l = ht(l, d, h.factor > 1 ? h.center : nt(u)), o({
		visibleArea: l,
		type: "move"
	})), rt(ut(u, et(l)))))), {
		coordinates: u,
...
function Pt(t) {
	var e = t.aspectRatio, i = t.getAreaRestrictions, n = t.coordinates, s = t.visibleArea, o = t.sizeRestrictions, r = t.positionRestrictions, a = t.imageSize, h = t.previousImageSize, c = t.angle, l = C({}, n), u = C({}, s), d = gt(nt(C({
		left: 0,
		top: 0
	}, h)), c);
	return (l = C(C({}, Mt({
		...
		width: l.width,
		height: l.height
	})), gt(nt(l), c))).left -= d.left - a.width / 2 + l.width / 2, l.top -= d.top - a.height / 2 + l.height / 2, u = ht(u, ft(u, i({
		visibleArea: u,
		type: "resize"
	}))), {
		coordinates: l = vt(l, r),
		visibleArea: u = vt(u = at(u, it(nt(l), nt(n))), i({
			visibleArea: u,
			type: "move"
		}))
	};
...
function $t(t) {
	...
	if (l || u) {
		...
		h = at(h, it(p, nt(h))), m = gt(nt(c), -n), c = vt(c = at(c, it(p = gt({
			left: l ? d.left - (m.left - d.left) : m.left,
			top: u ? d.top - (m.top - d.top) : m.top
		}, n), nt(c))), s({
			visibleArea: c,
...
function It(t) {
	...
	if (V.forEach((function(t) {
		...
		var m = Math.min.apply(null, V.map((function(t) {
			return d[t];
		})));
		m !== Infinity && V.forEach((function(t) {
			h[t] *= m;
		}));
	} else V.forEach((function(t) {
		d[t] !== Infinity && (h[t] *= d[t]);
	}));
	if (c = ot(i, h).width, l = ot(i, h).height, h.right + h.left && (c > o.maxWidth ? d.width = (o.maxWidth - i.width) / (h.right + h.left) : c < o.minWidth && (d.width = (o.minWidth - i.width) / (h.right + h.left))), h.bottom + h.top && (l > o.maxHeight ? d.height = (o.maxHeight - i.height) / (h.bottom + h.top) : l < o.minHeight && (d.height = (o.minHeight - i.height) / (h.bottom + h.top))), r) {
		...
		p !== Infinity && V.forEach((function(t) {
			h[t] *= p;
		}));
	} else d.width !== Infinity && _.forEach((function(t) {
		h[t] *= d.width;
	})), d.height !== Infinity && G.forEach((function(t) {
		h[t] *= d.height;
	}));
	return h;
}
...
var kt = {
	...
	computed: { classes: function() {
		...
		return {
			default: A(Xt(e), this.defaultClass, this.hover && this.hoverClass),
			wrapper: A(Yt(e), this.wrapperClass)
		};
	} },
	methods: {
		onDrag: function(t) {
...
var Nt = {
	...
	computed: { classes: function() {
		return {
			root: A(Ft(f({}, this.position, !0)), this.defaultClass, this.hover && this.hoverClass),
			wrapper: A(Ut(f({}, this.position, !0)), this.wrapperClass)
		};
	} },
	methods: {
		onDrag: function(t) {
...
var _t = {
		...
		lineNodes: function() {
			...
			return this.points.forEach((function(i) {
				i.horizontalDirection && i.verticalDirection || !t.lines[i.name] || e.push({
					...
					class: A(t.classes.lines.default, t.classes.lines[i.name], !t.resizable && t.classes.lines.disabled),
					wrapperClass: A(t.classes.linesWrappers.default, t.classes.linesWrappers[i.name], !t.resizable && t.classes.linesWrappers.disabled),
			...
			return this.points.forEach((function(s) {
				if (t.handlers[s.name]) {
					var o = {
						...
						class: A(t.classes.handlers.default, t.classes.handlers[s.name]),
						wrapperClass: A(t.classes.handlersWrappers.default, t.classes.handlersWrappers[s.name]),
					...
					} else o.wrapperClass = Zt("handler", f({}, s.classname, !0));
					e.push(o);
				}
			})), e;
		}
	...
	methods: {
		...
		onHandlerDrag: function(t, e, i) {
			var n, s = t.shift(), o = s.left, r = s.top, a = {
				left: 0,
				right: 0,
				top: 0,
				bottom: 0
			};
			"west" === e ? a.left -= o : "east" === e && (a.right += o), "north" === i ? a.top -= r : "south" === i && (a.bottom += r), !i && e ? n = "width" : i && !e && (n = "height"), this.resizable && this.$emit("resize", new X(a, {
				allowedDirections: {
					left: "west" === e || !e,
					right: "east" === e || !e,
					bottom: "south" === i || !i,
...
_t.render = function(n, o, c, l, u, d) {
	return openBlock(), createBlock("div", {
		...
		createVNode("div", null, [(openBlock(!0), createBlock(Fragment, null, renderList(d.lineNodes, (function(i) {
			return openBlock(), createBlock(resolveDynamicComponent(i.component), {
				key: i.name,
		...
		(openBlock(!0), createBlock(Fragment, null, renderList(d.handlerNodes, (function(i) {
			return openBlock(), createBlock("div", {
				key: i.name,
				style: i.wrapperStyle,
				class: i.wrapperClass
			}, [(openBlock(), createBlock(resolveDynamicComponent(i.component), {
				"default-class": i.class,
				"hover-class": i.hoverClass,
				"wrapper-class": i.wrapperClass,
...
var Qt = {
	...
	methods: {
		...
		onTouchMove: function(t) {
			this.touches.length >= 1 && (this.touchStarted ? (this.processMove(t, t.touches), t.preventDefault(), t.stopPropagation()) : I({
		...
		processMove: function(t, e) {
			...
			if (this.touches.length) {
				...
				1 === this.touches.length && 1 === i.length && this.$emit("move", new Y({
...
function Jt(t) {
	return new Promise((function(e, i) {
		try {
			if (t) if (/^data:/i.test(t)) e(function(t) {
	...
	computed: {
		classes: function() {
			return {
				root: ie(),
				wrapper: ie("wrapper"),
				imageWrapper: ie("image-wrapper"),
				image: A(ie("image"), this.imageClass)
			};
		},
		...
		imageStyle: function() {
			var t = this.image.transforms, e = pt({
...
function se(t, e) {
	var i = e.getBoundingClientRect(), n = i.left, s = i.top, o = {
		left: 0,
		top: 0
	}, r = 0;
...
ne.render = function(i, n, o, r, a, h) {
	return openBlock(), createBlock("div", { class: h.classes.root }, [createVNode("div", {
		ref: "wrapper",
...
var oe = {
	...
	created: function() {
		this.transforming = !1, this.debouncedProcessEnd = x(this.processEnd), this.touches = [];
	},
	methods: {
		processMove: function(t, e) {
			if (this.touches.length) {
				if (1 === this.touches.length && 1 === e.length) this.$emit("move", new B({
					...
					n.count === i.count && n.count > 1 && this.$emit("resize", new B({
		...
		onWheel: function(t) {
			if (this.wheelResize && this.processEvent(t)) {
				var e = this.$refs.container.getBoundingClientRect(), i = e.left, n = e.top, s = 1 + this.wheelResize.ratio * (r = t.deltaY || t.detail || t.wheelDelta, 0 === (a = +r) || $(a) ? a : a > 0 ? 1 : -1), o = {
					left: t.clientX - i,
					top: t.clientY - n
				};
				this.$emit("resize", new B({}, {
					factor: s,
					center: o
...
var re = {
	components: { TransformableImage: oe },
	props: {
		touchMove: {
			type: Boolean,
			required: !0
...
var he = {
	...
	computed: {
		classes: function() {
			return {
				root: ae({ fill: this.fill }),
				wrapper: ae("wrapper"),
				imageWrapper: ae("image-wrapper"),
				image: A(ae("image"), this.imageClass)
			};
		},
		style: function() {
			if (this.fill) return {};
		...
		imageStyle: function() {
			if (this.coordinates && this.image) {
				var t = this.coordinates.width / this.size.width, e = g(g({
					rotate: 0,
					flip: {
						horizontal: !1,
						vertical: !1
					...
					scaleX: 1 / t,
					scaleY: 1 / t
				}), i = this.imageSize.width, n = this.imageSize.height, s = pt({
					width: i,
					height: n
				}, e.rotate), o = {
					width: "".concat(i, "px"),
					...
					rotate: {
						left: (i - s.width) * e.scaleX / 2,
						top: (n - s.height) * e.scaleY / 2
					},
					scale: {
						left: (1 - e.scaleX) * i / 2,
						top: (1 - e.scaleY) * n / 2
...
var ce = {
	components: { Preview: he },
	inheritAttrs: !1
};
ce.render = function(i, s, o, r, a, h) {
	var c = resolveComponent("preview");
	return openBlock(), createBlock(c, mergeProps(i.$attrs, { fill: !0 }), null, 16);
};
	...
	computed: {
		classes: function() {
			return {
				...
				preview: A(le("preview"), this.previewClass),
				boundingBox: A(le("bounding-box"), this.boundingBoxClass)
			};
		},
		style: function() {
			var t = this.stencilCoordinates, e = t.height, i = t.width, n = t.left, s = t.top, o = {
				width: "".concat(i, "px"),
				height: "".concat(e, "px"),
	...
	computed: {
		classes: function() {
			return {
				...
				preview: A(de("preview"), this.previewClass),
				boundingBox: A(de("bounding-box"), this.boundingBoxClass)
			};
		},
		style: function() {
			var t = this.stencilCoordinates, e = t.height, i = t.width, n = t.left, s = t.top, o = {
...
var fe = {
	name: "Cropper",
	components: { BackgroundWrapper: re },
	props: {
		src: {
			type: String,
			default: null
		...
		resizeAlgorithm: {
			type: Function,
			default: function(t) {
				var e = t.event, i = t.coordinates, n = t.aspectRatio, s = t.positionRestrictions, o = t.sizeRestrictions, r = C(C({}, i), {
					right: i.left + i.width,
					bottom: i.top + i.height
				}), a = e.params || {}, h = C({}, e.directions), c = a.allowedDirections || {
					left: !0,
					right: !0,
					bottom: !0,
					top: !0
				};
				o.widthFrozen && (h.left = 0, h.right = 0), o.heightFrozen && (h.top = 0, h.bottom = 0), V.forEach((function(t) {
					c[t] || (h[t] = 0);
				}));
				var l = ot(r, h = It({
					coordinates: r,
				...
				})).width, u = ot(r, h).height, d = a.preserveRatio ? ct(r) : dt(l / u, n);
				if (d) {
					var m = a.respectDirection;
					if (m || (m = r.width >= r.height || 1 === d ? "width" : "height"), "width" === m) {
						var p = l / d - r.height;
						if (c.top && c.bottom) {
							var g = h.top, f = h.bottom;
							h.bottom = Bt(p, f, g), h.top = Bt(p, g, f);
						} else c.bottom ? h.bottom = p : c.top ? h.top = p : c.right ? h.right = 0 : c.left && (h.left = 0);
					} else if ("height" === m) {
						var v = r.width - u * d;
						if (c.left && c.right) {
							var b = h.left, w = h.right;
							h.left = -Bt(v, b, w), h.right = -Bt(v, w, b);
				...
				return l = ot(r, h).width, u = ot(r, h).height, (d = a.preserveRatio ? ct(r) : dt(l / u, n)) && Math.abs(d - l / u) > .001 && V.forEach((function(t) {
					c[t] || (h[t] = 0);
				})), St({
					event: new Y({
						left: -h.left,
		...
		fitCoordinates: {
			type: Function,
			default: function(t) {
				var e = t.visibleArea, i = t.coordinates, n = t.aspectRatio, s = t.sizeRestrictions, o = t.positionRestrictions, r = C(C({}, i), Mt({
					width: i.width,
					height: i.height,
					aspectRatio: n,
					sizeRestrictions: {
		...
		fitVisibleArea: {
			...
			default: function(t) {
				...
				var r = rt(ut(s, et(o = ht(o, ft(o, n({
					visibleArea: o,
					type: "resize"
				}))))));
				return o.width < s.width && (r.left = 0), o.height < s.height && (r.top = 0), o = vt(o = at(o, r), n({
					visibleArea: o,
					type: "move"
				}));
			}
	...
	computed: {
		...
		sizeRestrictions: function() {
			if (this.boundaries.width && this.boundaries.height && this.imageSize.width && this.imageSize.height) {
				var t = this.sizeRestrictionsAlgorithm({
					imageSize: this.imageSize,
					minWidth: D(this.minWidth) ? 0 : L(this.minWidth),
					minHeight: D(this.minHeight) ? 0 : L(this.minHeight),
					maxWidth: D(this.maxWidth) ? Infinity : L(this.maxWidth),
					maxHeight: D(this.maxHeight) ? Infinity : L(this.maxHeight)
				});
				if (t = function(t) {
					var e = t.areaRestrictions, i = t.sizeRestrictions;
					t.imageSize;
					var n = t.boundaries, s = t.positionRestrictions;
					t.imageRestriction;
					var o = C(C({}, i), {
						minWidth: void 0 !== i.minWidth ? i.minWidth : 0,
						minHeight: void 0 !== i.minHeight ? i.minHeight : 0,
						maxWidth: void 0 !== i.maxWidth ? i.maxWidth : Infinity,
						maxHeight: void 0 !== i.maxHeight ? i.maxHeight : Infinity
					});
					...
					var r = bt(e), a = mt(n, r);
					return r.width < Infinity && (!o.maxWidth || o.maxWidth > a.width) && (o.maxWidth = Math.min(o.maxWidth, a.width)), r.height < Infinity && (!o.maxHeight || o.maxHeight > a.height) && (o.maxHeight = Math.min(o.maxHeight, a.height)), o.minWidth > o.maxWidth && (o.minWidth = o.maxWidth, o.widthFrozen = !0), o.minHeight > o.maxHeight && (o.minHeight = o.maxHeight, o.heightFrozen = !0), o;
				}({
					sizeRestrictions: t,
					...
					var e = this.getStencilSize(), i = bt(this.getAreaRestrictions({
						visibleArea: this.visibleArea,
						type: "resize"
					}));
		...
		classes: function() {
			return {
				cropper: ge(),
				image: A(ge("image"), this.imageClass),
				stencil: ge("stencil"),
				boundaries: A(ge("boundaries"), this.boundariesClass),
				stretcher: A(ge("stretcher")),
				background: A(ge("background"), this.backgroundClass),
				foreground: A(ge("foreground"), this.foregroundClass),
				imageWrapper: A(ge("image-wrapper")),
				cropperWrapper: A(ge("cropper-wrapper"))
			};
		},
		...
		imageStyle: function() {
			var t = this.imageAttributes.width > this.imageAttributes.height ? {
				...
				left: "0px",
				top: "0px",
				transform: "translate(".concat(-e.left - i.left - this.imageTransforms.translateX, "px, ").concat(-e.top - i.top - this.imageTransforms.translateY, "px)") + te(n)
			};
	...
	created: function() {
		this.debouncedUpdate = x(this.update, this.debounce), this.debouncedDisableTransitions = x(this.disableTransitions, this.transitionsOptions.time), this.awaiting = !1;
	},
	mounted: function() {
	...
	methods: {
		getResult: function() {
			var t = this.initialized ? this.prepareResult(g({}, this.coordinates)) : this.defaultCoordinates(), e = {
				rotate: this.imageTransforms.rotate % 360,
				flip: g({}, this.imageTransforms.flip)
			};
			if (this.src && this.imageLoaded) {
				...
				return {
					image: this.image,
					coordinates: t,
					visibleArea: this.visibleArea ? g({}, this.visibleArea) : null,
					imageTransforms: e,
					get canvas() {
		...
		zoom: function(t, e) {
			var n = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).transitions, s = void 0 === n || n;
			this.onManipulateImage(new B({}, {
				factor: 1 / t,
				center: e
			}), {
				normalize: !1,
		...
		prepareResult: function(t) {
			return this.roundResult ? function(t) {
				var e = t.coordinates, i = t.sizeRestrictions, n = t.positionRestrictions, s = {
			...
			}(g(g({}, this.getPublicProperties()), {}, {
				positionRestrictions: jt(this.positionRestrictions, this.visibleArea),
				coordinates: t
			})) : t;
		},
		...
		normalizeEvent: function(t) {
			return function(t) {
				var e = t.event, i = t.visibleArea, n = t.coefficient;
				if ("manipulateImage" === e.type) return C(C({}, e), {
					move: {
		...
		getCanvas: function() {
			if (this.$refs.canvas) {
				var t = this.$refs.canvas, e = this.$refs.image, i = 0 !== this.imageTransforms.rotate || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? function(t, e, i) {
					var n = i.rotate, s = i.flip, o = {
						width: e.naturalWidth,
						height: e.naturalHeight
					}, r = pt(o, n), a = t.getContext("2d");
				...
				}(this.$refs.sourceCanvas, e, this.imageTransforms) : e, n = g({
					minWidth: 0,
					minHeight: 0,
					maxWidth: Infinity,
					maxHeight: Infinity,
					...
					sizeRestrictions: {
						...
						maxWidth: s([n.width, n.maxWidth]) || Infinity,
						maxHeight: s([n.height, n.maxHeight]) || Infinity
					},
				...
				if (n.maxArea && o.width * o.height > n.maxArea) {
					...
					o = {
						width: Math.round(r * o.width),
						height: Math.round(r * o.height)
					};
				}
				return function(t, e, i, n, s) {
					...
					var r = i.left < 0 ? -i.left : 0, a = i.top < 0 ? -i.top : 0;
					o.drawImage(e, i.left + r, i.top + a, i.width, i.height, r * (t.width / i.width), a * (t.height / i.height), t.width, t.height);
		...
		resetCoordinates: function() {
			...
			if (this.$refs.image) {
				...
				var n = O(e) ? e({
					...
					stencilSize: this.getStencilSize(),
					visibleArea: this.visibleArea
				}) : e, s = this.defaultPosition || Tt, o = [n, function(e) {
					var i = e.coordinates;
					return g({}, O(s) ? s({
						coordinates: i,
				...
				this.delayedTransforms && o.push.apply(o, b(Array.isArray(this.delayedTransforms) ? this.delayedTransforms : [this.delayedTransforms])), this.coordinates = this.applyTransform(o, !0), this.delayedTransforms = null;
			}
		},
		clearImage: function() {
			var t = this;
		...
		updateBoundaries: function() {
			...
			return this.initStretcher({
				...
				if (O(t.defaultBoundaries) ? t.boundaries = t.defaultBoundaries(e) : "fit" === t.defaultBoundaries ? t.boundaries = function(t) {
					var e = t.cropper, i = t.imageSize, n = e.clientHeight, s = e.clientWidth, o = n, r = i.width * n / i.height;
		...
		resetVisibleArea: function() {
			...
			return this.appliedImageTransforms = g(g({}, this.defaultImageTransforms), {}, { flip: g({}, this.defaultImageTransforms.flip) }), this.updateBoundaries().then((function() {
				...
				t.visibleArea = O(a) ? a({
					...
					boundaries: t.boundaries,
					getAreaRestrictions: t.getAreaRestrictions
				}, i = e.visibleArea, n = e.boundaries, s = e.getAreaRestrictions, o = C({}, i), r = ct(n), o.width / o.height !== r && (o.height = o.width / r), vt(o, s({
					visibleArea: o,
					type: "move"
		...
		onChangeImage: function() {
			...
			if (this.imageLoaded = !1, this.delayedTransforms = null, this.src) {
				if (function(t) {
					if (T(t)) return !1;
					var e = window.location, i = /(\w+:)?(?:\/\/)([\w.-]+)?(?::(\d+))?\/?/.exec(t) || [], n = {
						protocol: i[1] || "",
						host: i[2] || "",
						port: i[3] || ""
					}, s = function(t) {
		...
		onParseImage: function(t) {
			...
			this.imageAttributes.revoke && this.imageAttributes.src && URL.revokeObjectURL(this.imageAttributes.src), this.imageAttributes.revoke = !1, n && s && s > 1 ? W(i) || !T(i) ? (this.imageAttributes.src = URL.createObjectURL(new Blob([n])), this.imageAttributes.revoke = !0) : this.imageAttributes.src = function(t) {
			...
			}(n) : this.imageAttributes.src = i, O(this.defaultTransforms) ? this.appliedImageTransforms = Kt(this.defaultTransforms()) : H(this.defaultTransforms) ? this.appliedImageTransforms = Kt(this.defaultTransforms) : this.appliedImageTransforms = function(t) {
				var e = Kt({});
				if (t) switch (t) {
					case 2:
						e.flip.horizontal = !0;
		...
		onMove: function(t) {
			...
			this.transitionsOptions.enabled || this.awaitRender((function() {
				e.coordinates = e.moveAlgorithm(g(g({}, e.getPublicProperties()), {}, {
					positionRestrictions: jt(e.positionRestrictions, e.visibleArea),
		...
		getStencilSize: function() {
			...
			}, e = t.boundaries, i = t.stencilSize, n = t.aspectRatio, dt(ct(s = O(i) ? i({
				boundaries: e,
				aspectRatio: n
			}) : i), n) && (s = Mt({
				sizeRestrictions: {
			...
			})), (s.width > e.width || s.height > e.height) && (s = Mt({
				sizeRestrictions: {
					maxWidth: e.width,
					maxHeight: e.height,
					minWidth: 0,
		...
		flip: function(t, e) {
			...
			if (!this.transitionsActive) {
				...
				var o = g({}, this.imageTransforms.flip), r = $t({
					flip: {
		...
		rotate: function(t) {
			var i = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).transitions, n = void 0 === i || i;
			if (!this.transitionsActive) {
				n && this.enableTransitions();
				...
				var o = Pt({
					...
					getAreaRestrictions: this.getAreaRestrictions,
					aspectRatio: this.getAspectRatio()
				}), r = o.visibleArea, a = o.coordinates, h = this.processAutoZoom("rotateImage", r, a);
...
fe.render = function(i, n, r, a, p, g) {
	return openBlock(), createBlock("div", {
		ref: "cropper",
		class: g.classes.cropper
	}, [createVNode("div", {
		ref: "stretcher",
		class: g.classes.stretcher
	}, null, 2), createVNode("div", {
		class: g.classes.boundaries,
		style: g.boundariesStyle
	}, [(openBlock(), createBlock(resolveDynamicComponent(r.backgroundWrapperComponent), {
		...
		default: withCtx((function() {
			return [
				createVNode("div", {
					class: g.classes.background,
					style: g.boundariesStyle
				}, null, 6),
				createVNode("div", { class: g.classes.imageWrapper }, [createVNode("img", {
					ref: "image",
				...
				createVNode("div", {
					class: g.classes.foreground,
					style: g.boundariesStyle
				}, null, 6),
				withDirectives((openBlock(), createBlock(resolveDynamicComponent(r.stencilComponent), mergeProps({
					ref: "stencil",
					image: g.image,
				...
				r.canvas ? (openBlock(), createBlock("canvas", ve, null, 512)) : createCommentVNode("", !0),
				r.canvas ? (openBlock(), createBlock("canvas", be, null, 512)) : createCommentVNode("", !0)
			];
		})),
		_: 1
	}, 8, [
