...
export declare const VStepperWindow: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<{
        ...
        default: (arg: {
            group: import("vuetify/lib/composables/group.js").GroupProvide;
        ...
        prev: (arg: {
            props: {
                icon: import("vuetify/lib/composables/icons.js").IconValue;
                class: string;
                onClick: () => void;
                "aria-label": string;
            };
    ...
    modelValue?: TModel | undefined;
    "onUpdate:modelValue"?: ((value: TModel) => void) | undefined;
}, VWindowSlots>) & import("vuetify/lib/util/index.js").FilterPropsOptions<{
