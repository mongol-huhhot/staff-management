...
import type { DataTableItemProps } from 'vuetify/lib/components/VDataTable/composables/items.js';
import type { EventProp, ValueComparator } from 'vuetify/lib/util/index.js';
