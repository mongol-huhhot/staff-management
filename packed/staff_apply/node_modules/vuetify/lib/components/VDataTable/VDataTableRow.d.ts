...
import type { CellProps, DataTableItem, ItemKeySlot } from 'vuetify/lib/components/VDataTable/types.js';
import type { VDataTableHeaderCellColumnSlotProps } from 'vuetify/lib/components/VDataTable/VDataTableHeaders.js';
...
export declare const VDataTableRow: {
    ...
    item?: DataTableItem<T> | undefined;
    cellProps?: CellProps<T> | undefined;
}, VDataTableRowSlots<T>>) & import("vuetify/lib/util/index.js").FilterPropsOptions<{
    mobile: {
        type: PropType<boolean | null>;
        default: boolean;
    };
