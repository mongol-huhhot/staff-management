import { DateCompWrapper } from 'ag-grid-community/dist/types/core/filter/provided/date/dateCompWrapper';
import { ISimpleFilterModel, SimpleFilterModelFormatter, Tuple } from 'ag-grid-community/dist/types/core/filter/provided/simpleFilter';
import { Comparator, IScalarFilterParams, ScalarFilter } from 'ag-grid-community/dist/types/core/filter/provided/scalarFilter';
import { IAfterGuiAttachedParams } from 'ag-grid-community/dist/types/core/interfaces/iAfterGuiAttachedParams';
import { IFilterOptionDef, IFilterParams } from 'ag-grid-community/dist/types/core/interfaces/iFilter';
...
import { FILTER_LOCALE_TEXT } from 'ag-grid-community/dist/types/core/filter/filterLocaleText';
...
export declare class DateFilter extends ScalarFilter<DateFilterModel, Date, DateCompWrapper> {
    static DEFAULT_FILTER_OPTIONS: import("ag-grid-community/dist/types/core/filter/provided/simpleFilter").ISimpleFilterModelType[];
