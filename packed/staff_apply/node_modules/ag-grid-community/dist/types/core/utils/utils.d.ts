import * as AriaUtils from 'ag-grid-community/dist/types/core/utils/aria';
export declare const _: {
    ...
    sortRowNodesByOrder(rowNodes: import("ag-grid-community/dist/types/core/main").RowNode<any>[], rowNodeOrder: {
        [id: string]: number;
    }): boolean;
    ...
    isUserSuppressingKeyboardEvent(gos: import("ag-grid-community/dist/types/core/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, rowNode: import("ag-grid-community/dist/types/core/main").IRowNode<any>, column: import("ag-grid-community/dist/types/core/main").Column<any>, editing: boolean): boolean;
    isUserSuppressingHeaderKeyboardEvent(gos: import("ag-grid-community/dist/types/core/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, headerRowIndex: number, column: import("ag-grid-community/dist/types/core/main").Column<any> | import("ag-grid-community/dist/types/core/main").ColumnGroup): boolean;
    ...
    createIcon(iconName: string, gos: import("ag-grid-community/dist/types/core/gridOptionsService").GridOptionsService, column: import("ag-grid-community/dist/types/core/main").Column<any> | null): Element;
    createIconNoSpan(iconName: string, gos: import("ag-grid-community/dist/types/core/gridOptionsService").GridOptionsService, column?: import("ag-grid-community/dist/types/core/main").Column<any> | null | undefined, forceCreate?: boolean | undefined): Element | undefined;
    iconNameClassMap: {
        [key: string]: string;
    };
    ...
    getCtrlForEventTarget<T_13>(gos: import("ag-grid-community/dist/types/core/gridOptionsService").GridOptionsService, eventTarget: EventTarget | null, type: string): T_13 | null;
    ...
    addSafePassiveEventListener(frameworkOverrides: import("ag-grid-community/dist/types/core/main").IFrameworkOverrides, eElement: HTMLElement, event: string, listener: (event?: any) => void): void;
    ...
    addStylesToElement(eElement: any, styles: import("ag-grid-community/dist/types/core/main").RowStyle | import("ag-grid-community/dist/types/core/main").CellStyle | null | undefined): void;
    ...
    bindCellRendererToHtmlElement(cellRendererPromise: import("ag-grid-community/dist/types/core/utils/promise").AgPromise<import("ag-grid-community/dist/types/core/main").ICellRendererComp<any>>, eTarget: HTMLElement): void;
    ...
    getAriaSortState(sortDirection: import("ag-grid-community/dist/types/core/main").SortDirection | "mixed"): AriaUtils.ColumnSortState;
