var config = require('encoding-japanese/src/config');
var util = require('encoding-japanese/src/util');
var EncodingDetect = require('encoding-japanese/src/encoding-detect');
var EncodingConvert = require('encoding-japanese/src/encoding-convert');
var KanaCaseTable = require('encoding-japanese/src/kana-case-table');
var version = require('encoding-japanese/package.json').version;
