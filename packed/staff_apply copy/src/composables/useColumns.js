...
export function buildInitColumns(onRowClicked) {
    return [
        ...
        //     flex:1,
        // },
        { field : 'valid_from', headerName: '適用開始日',
            cellStyle: { textAlign: 'center', padding: '4px',
                color: '#1976d2',          // blue
                textDecoration: 'underline',
                cursor: 'pointer',         // optional (クリック可能っぽく見せる)
        ...
        { field : 'request_status', headerName: '申請ステータス', 
            cellStyle: { textAlign: 'center', padding: '4px',
                color: '#1976d2',          // blue
                textDecoration: 'underline',
                cursor: 'pointer',         // optional (クリック可能っぽく見せる)
        ...
        { field : 'valid_from', headerName: '適用開始日', },
        { field : 'request_status', headerName: '申請ステータス', },
        { field : 'requested_at', headerName: '申請日時', },
        { field : 'updated_at', headerName: '更新日時', },
        { field : 'requested_by', headerName: '申請者', },
        //{ field : '', headerName: '編集可否', },
