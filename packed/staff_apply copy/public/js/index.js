...
window.appConfig.MAIN_CONFIG = {
  ...
  tab2sqltag_list: {
    ...
    address: {
      ...
      jsonb_fields: ['data_jsonb'],// jsonb カラムの一覧
      skip_reload: false,
      sqltags:{ select:'get_staff_personal_request',insert:'',update:'update_staff_request_info',  delete:'' },
      separate_items: ['id','approved_at','approved_by','rejected_at','rejected_by', 'staff_id', 'data_type', 'valid_from', 
                       'created_at', 'created_by', 'updated_at', 'updated_by','request_type', 'requested_at', 'requested_by', 
                       'request_status', 'request_comment', 'approval_comment','new_request_status'],// jsonb以外の普通カラム
    },
    contact: {
      ...
      jsonb_fields: ['data_jsonb'],// jsonb カラムの一覧
      skip_reload: false,
      sqltags:{ select:'get_staff_personal_request', insert:'test_insert_staff_request_info',update:'update_staff_request_info', delete:'' },
      separate_items: ['id','approved_at','approved_by','rejected_at','rejected_by', 'staff_id', 'data_type', 'valid_from', 
                       'created_at', 'created_by', 'updated_at', 'updated_by','request_type', 'requested_at', 'requested_by', 
                       'request_status', 'request_comment', 'approval_comment','new_request_status'],// jsonb以外の普通カラム
    },
    ...
    bank: {
      ...
      data_key: 'staff_bank',
      jsonb_fields: ['data_jsonb'],// jsonb カラムの一覧
      sqltags:{ select:'masters.get_staff_bank_request',insert:'test_insert_staff_request_info',update:'update_staff_request_info', delete:''}, // jsonb以外の普通カラム
      separate_items: ['id','approved_at','approved_by','rejected_at','rejected_by', 'staff_id', 'data_type', 'valid_from', 
                       'created_at', 'created_by', 'updated_at', 'updated_by','request_type', 'requested_at', 'requested_by', 
                       'request_status', 'request_comment', 'approval_comment','new_request_status','record_id'],// jsonb以外の普通カラム
    },
