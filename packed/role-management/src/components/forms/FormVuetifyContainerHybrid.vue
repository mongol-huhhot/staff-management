...
const categoryCode = 'role_management'
...
const loadActiveTabData = async (tabCode = activeName.value, options = {}) => {
  console.log("loadActiveTabData====", tabCode )
  ...
  console.log("loadActiveTabData1111111111111111111111111111====", loadedTabs.value[tabCode] )

  const row = currentStaffRow.value
  const staffKey = getStaffKey(row)

  console.log("loadActiveTabData22222222222222222222222====", row )

  // if (!staffKey && tabNeedStaff(tabCode)) return

  console.log("loadActiveTabData3333333333333333333333333====", row )

  const cacheKey = `no-staff:${tabCode}`
  ...
  console.log("loadActiveTabData4444444444444444444444444====", row )
...
watch(
  ...
  async (newVal) => {
    ...
    formData.value[activeName.value] = {...dataStore.states.currentRow}
  ...
  <v-card class="container-card" variant="outlined">
    <v-card-title class="card-header">
      <div class="header-left truncated">
        {{ formData }}
        <!-- {{formData[tab.sub_category_code]} -->
